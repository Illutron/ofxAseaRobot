...
//=============================================================================
// $Id: Image.h,v 1.38 2009/05/12 20:51:49 soowei Exp $
//=============================================================================
...
namespace FlyCapture2
{
    ...
    public:
        ...
        */ 
         ...
         * internally. If the Image also has a buffer attached to it, it will
         * will released.
         *
         ...
         * is consider unsafe. The pointer returned could be invalidated if
         * the buffer is resized or released.
         *
